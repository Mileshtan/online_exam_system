            ...
            @if(count($attempts)>0)
                ...
                @foreach($attempts as $attempt)
                    <tr>
                        ...
                        <td>
                            @if($attempt->status == 0)
                                <a href="#" data-toggle="modal" class="reviewExam" data-id="{{$attempt->id}}" data-target="#reviewExamModal">Review & Approved</a>
                            @else
                                Completed
                            @endif
                        </td>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Exam Review</h5>
                    ...
                    success:function(data){
                        ...
                        if (data.success == true) {
                            ...
                            if(data.length > 0)
                            {
                                ...
                                html +=`<h6>Student has not attempt any Questions</h6>
